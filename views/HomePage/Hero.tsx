...
export default function Hero() {
  ...
  return (
    <HeroWrapper>
      <Contents>
        <CustomOverTitle>நவராத்திரி தினங்களில் தேவிக்கு அலங்காரங்கள் என்ன, நவராத்திரி தினங்களின் ஒவ்வொரு நாளுக்கான பெருமைகள் என்ன, நாம் எப்படி அன்னையை வணங்க வேண்டும் என்பதை இங்கு பார்ப்போம்...</CustomOverTitle>
